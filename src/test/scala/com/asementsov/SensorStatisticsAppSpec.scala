...
class SensorStatisticsAppSpec extends FlatSpec with Matchers with LazyLogging {
  ...
  "SensorStatisticsApp.aggregateFileStat" should "process leader-1.csv properly" in {
  ...
  it should "process leader-2.csv properly" in {
  ...
  "SensorStatisticsApp" should "pass happy path test" in {
  ...
  it should "process file with incorrect data" in {

  }

  it should "process file without header" in {

  }

  it should "process out of memory file" in {
